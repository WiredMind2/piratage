...
class Ui_MainWindow( object ):
    ...
    def setupUi(self, fen):
        fen.title( "fen" )
        """fen.geometry( "960x456" )

        fen.iconphoto(False, PhotoImage(file='./pics/bgv7.png'))

        filename = PhotoImage(file = "./pics/bgv7.png")
        ...
        Checkbutton(self.fen, text="Wallhack", variable=self.checkBox).grid(row=2, column=0, sticky=W)

        self.checkBox_2 = IntVar()
        Checkbutton(self.fen, text="NoFlash", variable=self.checkBox_2).grid(row=3, column=0, sticky=W)

        self.checkBox_3 = IntVar()
        Checkbutton(self.fen, text="Radar", variable=self.checkBox_3).grid(row=5, column=0, sticky=W)

        self.checkBox_4 = IntVar()
        Checkbutton(self.fen, text="FOV Changer", variable=self.checkBox_4).grid(row=0, column=0, sticky=W)

        self.checkBox_5 = IntVar()
        Checkbutton(self.fen, text="Triggerbot", variable=self.checkBox_5).grid(row=0, column=1, sticky=W)

        self.checkBox_6 = IntVar()
        Checkbutton(self.fen, text="Aimbot", variable=self.checkBox_6).grid(row=1, column=1, sticky=W)

        self.checkBox_7 = IntVar()
        Checkbutton(self.fen, text="Aim for Body", variable=self.checkBox_7).grid(row=3, column=1, sticky=W)

        self.checkBox_8 = IntVar()
        Checkbutton(self.fen, text="Bunnyhop", variable=self.checkBox_8).grid(row=5, column=1, sticky=W)

        self.checkBox_9 = IntVar()
        Checkbutton(self.fen, text="Silentaim", variable=self.checkBox_9).grid(row=2, column=1, sticky=W)

        self.checkBox_10 = IntVar()
        Checkbutton(self.fen, text="Recoil Control", variable=self.checkBox_10).grid(row=4, column=0, sticky=W)

        self.checkBox_11 = IntVar()
        Checkbutton(self.fen, text="Hold To Change", variable=self.checkBox_11).grid(row=1, column=0, sticky=W)

        self.checkBox_12 = IntVar()
        Checkbutton(self.fen, text="RCS with Aimbot", variable=self.checkBox_12).grid(row=4, column=1, sticky=W)

        self.lineEdit = Entry(self.fen)
        self.lineEdit.insert(END, 'any number')
        self.lineEdit.grid(row=0, column=3, sticky=W)
        self.lineEdit_2 = Entry(self.fen)
        self.lineEdit_2.insert(END, 'e.g c')
        self.lineEdit_2.grid(row=1, column=3, sticky=W)
        self.lineEdit_3 = Entry(self.fen)
        self.lineEdit_3.insert(END, 'e.g shift')
        self.lineEdit_3.grid(row=2, column=3, sticky=W)
        self.lineEdit_4 = Entry(self.fen)
        self.lineEdit_4.insert(END, 'any number')
        self.lineEdit_4.grid(row=3, column=3, sticky=W)
        self.lineEdit_6 = Entry(self.fen)
        self.lineEdit_6.insert(END, 'e.g alt')
        self.lineEdit_6.grid(row=4, column=3, sticky=W)

        self.label = Label(self.fen, text="FOV Value")
        self.label.grid(row=0, column=2, sticky=W)
        self.label_2 = Label(self.fen, text="FOV Toggle Key")
        self.label_2.grid(row=1, column=2, sticky=W)
        self.label_3 = Label(self.fen, text="Triggerbot Key")
        self.label_3.grid(row=2, column=2, sticky=W)
        self.label_4 = Label(self.fen, text="Aimbot FOV")
        self.label_4.grid(row=3, column=2, sticky=W)
        self.label_6 = Label(self.fen, text="Aimbot Key")
        self.label_6.grid(row=4, column=2, sticky=W)

        self.pushButton = Button(self.fen,text="Update",command=self.update)
        self.pushButton.grid(row=6, column=0, sticky=W)
        self.pushButton_2 = Button(self.fen,text="Rank Reveal",command=self.rankreveal)
        self.pushButton_2.grid(row=6, column=3, sticky=W)

        """self.statusbar = QtWidgets.QStatusBar( fen )
        self.statusbar.setObjectName( "statusbar" )
        fen.setStatusBar( self.statusbar )"""
